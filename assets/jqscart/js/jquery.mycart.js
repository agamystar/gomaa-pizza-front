 ...
 * http://asraf-uddindeliveryithub.io/
  ...
  var loadMyCartEvent = function (targetSelector) {
    ...
    if (!$("#" + idCartModal).length) {
      $('body').append(
        ...
        '<table class="table table-hover table-responsive products" id="' + idCartTable + '"></table>' +
        '</div>' +
        '<div class="modal-footer">' +
        '<button type="button" class="btn btn-default products" data-dismiss="modal">Close</button>' +
        '<button type="button" class="btn products btn-primary ' + classCheckoutCart + '">Checkout</button>' +
        '</div>' +
        '</div>' +
        '</div>' +
        '</div>'
    ...
    var drawTable = function () {
      ...
      if (products.length && discountPrice !== null) {
        $cartTable.append(
          // '<tr style="color: red">' +
          // '<td></td>' +
          // '<td><strong>Total ( + 10$ delivery )</strong></td>' +
          // '<td></td>' +
          // '<td></td>' +
    ...
    */
    ...
    $(document).on('click', "." + classCheckoutCart, function () {
      ...
      location.href=window.location.protocol + "//" +window.location.host+'/checkout';
      updateCart();
